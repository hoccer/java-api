...
* download our "prebuild JAR":https://github.com/downloads/hoccer/java-api/java-linccer-client-v0.3.jar and "dependency zip":https://github.com/downloads/hoccer/java-api/java-flavored-api-dependencies.zip containing JAR files for Apache HttpClient and JSON
