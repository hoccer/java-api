...
* download our "prebuild JAR":https://github.com/downloads/hoccer/java-api/java-linccer-client-v0.2.2.jar and "dependency zip":https://github.com/downloads/hoccer/java-api/java-flavored-api-dependencies.zip containing JAR files for Apache HttpClient and JSON
* write some java code using the Linccer
* compile and run with JAR's in classpath

h2. Deployment

* obtain and use an dedicated API Key from "developer.hoccer.com":http://developer.hoccer.com
